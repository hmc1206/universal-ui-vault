    ...
    <label className={joinClasses("block font-['SF_Pro_Display']", className)} htmlFor={inputId}>
      ...
      <span className="relative block">
        <input
          ...
          className={joinClasses("min-h-12 w-full rounded-[22px] border border-[#d2d2d7] bg-white px-4 text-base text-[#1d1d1f] outline-none motion-reduce:transform-none motion-reduce:transition-none contrast-more:outline contrast-more:outline-2 contrast-more:outline-current focus-within:outline focus-within:outline-2 focus-within:outline-current shadow-[0_8px_20px_rgba(15,23,42,0.07)] backdrop-blur-md placeholder:text-[#6e6e73] transition-all duration-500 ease-out focus:border-[#0071e3] focus:shadow-[0_14px_30px_rgba(15,23,42,0.12)] focus:ring-2 focus:ring-[#0071e3]/20", inputClassName)}
          id={inputId}
          type={type}
        />
      </span>
